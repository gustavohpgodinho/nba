  ...
  obj2 %>% 
    dplyr::mutate(i = 0,
                  ...
                  importance = ifelse(nums %in% c('11000000000000000', '11000001000000000', '11001100000010000', '11110000000000000', 
                                                  ...
                                                  '21001100000001000', '12111100000010000', '21110000000000000') & stringr::str_detect(cod, "_3"), 0, importance),
                  importance = ifelse(nums %in% c('00110000000000000', '00110010000000000', '00110000001000000', '00220000000000000', 
                                                  ...
                                                  '12330000000001000', '13220000000000000', '22002200000010000', '11000001100000000',
                                                  '11000000000001000', '21001100000001000', '12111100000010000', '21110000000000000') & stringr::str_detect(cod, "_14"), 0, importance),
                  importance = ifelse(nums %in% c('00110000000000000', '00110010000000000', '00110000001000000', '00220000000000000', 
                                                  ...
                                                  '12111100000010000', '21110000000000000') & stringr::str_detect(cod, "_33"), 0, importance),
                  importance = ifelse(nums %in% c('11110000000000000', '11220000000000000', '12110000000000000', '12220000000000000', 
                                                  ...
                                                  '21110000000000000') & stringr::str_detect(modcod, "_6(.+)?_16") & stringr::str_detect(cod, "_16"), 0, importance),
                  importance = ifelse(nums %in% c('10220000000000000', '10221100000000000', '10221100000001000', '11110000000000000', 
                                                  ...
                                                  '13220000000000000', '12111100000010000') & stringr::str_detect(modcod, "_16(.+)?_6") & stringr::str_detect(cod, "_6"), 0, importance),
                  importance = ifelse(nums %in% c('10220000000000000', '10221100000000000', '10221100000001000', '11220000000000000',
                                                  ...
                                                  '13220000000000000', '21110000000000000') & stringr::str_detect(modcod, "_16(.+)?_6") & stringr::str_detect(cod, "_16") & stringr::str_detect(before_cod, "_16"), 0, importance),
                  importance = ifelse(nums %in% c('00000000010000000') & stringr::str_detect(last_cod, "_10\\(.\\)") & stringr::str_detect(cod, "_4"), 0, importance),
                  importance = ifelse(nums %in% c('11000001000000000', '12000001000000000', '11000001100000000') & stringr::str_detect(cod, "_5\\((19|20)p\\)") & stringr::str_detect(modcod, "_3_5"), 0, importance),
                  importance = ifelse(nums %in% c('10000001000000000', '11000001100000000') & stringr::str_detect(cod, "_5\\((19|20)p\\)") & stringr::str_detect(modcod, "_(6|10)_5"), 0, importance),
                  importance = ifelse(nums %in% c('00220000000000000', '00220000000001000', '10220000000000000', '10221100000000000', 
                                                  '10221100000001000', '10220000000001000', '00330000000000000') & stringr::str_detect(cod, "_16") & stringr::str_detect(last_cod, "_16|_33"), 0, importance),
                  importance = ifelse(nums %in% c('12000000000001000', '13000000000001000', '11000000000001000') & stringr::str_detect(cod, "_6"), 0, importance),
                  importance = ifelse(nums %in% c('12000000000001000', '13000000000001000') & stringr::str_detect(cod, "_3") & stringr::str_detect(before_cod, "_3"), 0, importance),
                  ...
                  importance = ifelse(nums %in% c('00110000001000000', '12200000000000000', '00200000000000000', '00100000000000000') & stringr::str_detect(cod, "_16"), 0, importance),
                  ...
                  importance = ifelse(nums %in% c('00110000000010001') & stringr::str_detect(cod, "_5\\((39|40)"), 0, importance),
                  importance = ifelse(nums %in% c('00000100000000000') & stringr::str_detect(cod, "_5\\((00|13)"), 1, importance),
                  importance = ifelse(nums %in% c('24000000000000000') & stringr::str_detect(cod, "_6") & stringr::str_detect(last_cod, "_6"), 0, importance),
                  ...
                  i = ifelse(nums == '12111100000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '10220000000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '11000000100000000' & importance == 1, 1, i),
                  i = ifelse(nums == '00110000000010001' & importance == 1, 1, i),
                  i = ifelse(nums == '25000000000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '00000100000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '11000000200000000' & importance == 1, 1, i),
                  i = ifelse(nums == '24000000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '12200000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '22110000000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '23000000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '00200000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '22001100000010000' & importance == 1, 1, i),
                  i = ifelse(nums == '12330000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '23001100000011000' & importance == 1, 1, i),
                  i = ifelse(nums == '00330000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '00000000000000100' & importance == 1, 1, i),
                  i = ifelse(nums == '13000000000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '12330000000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '13220000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '22002200000010000' & importance == 1, 1, i),
                  i = ifelse(nums == '11000001100000000' & importance == 1, 1, i),
                  i = ifelse(nums == '00100000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '00000000000000010' & importance == 1, 1, i),
                  i = ifelse(nums == '11000000000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '21001100000001000' & importance == 1, 1, i),
                  i = ifelse(nums == '12111100000010000' & importance == 1, 1, i),
                  i = ifelse(nums == '21110000000000000' & importance == 1, 1, i),
                  i = ifelse(nums == '00000000001000000' & importance == 1, 1, i),
                  i = ifelse(nums == '12000001000000000' & importance == 1, 1, i)) %>% 
    dplyr::group_by(joincod) %>% 
    ...
    dplyr::filter(nums == '00000000001000000') %>% 
